...
<div class="content">
<h1 class="common_title">Regístrate en Negofeed</h1>
...
<div class="default_form">
   ...
   <?php echo $form->create('User', array('url' => array('controller' => 'users', 'action' => 'signup'))); ?>
      <div class="default-form-elements">
         ...
         <div class="default-form-elem-input"><?php echo $form->input('email', array( 'type' => 'text', 'label' => false, 'error' => false)); ?></div>
      </div>
      <div class="default-form-elements">
         <div class="default-form-elem-label"><label for="UserPassword"><span>Tu contraseña</span></label></div>
         <div class="default-form-elem-input"><?php echo $form->input('password', array( 'type' => 'password', 'label' => false)); ?></div>
      </div>
      <div class="default-form-elements">
         <div class="default-form-elem-label"><label for="UserPasswordRepeat"><span>Confirma tu contraseña</span></label></div>
         <div class="default-form-elem-input"><?php echo $form->input('password2', array('type' => 'password', 'label' => false)); ?></div>
      </div>      
      <div id="default-form_button">
         <br />
			<button id="default-form_btn" type="submit">
				<span id="default-form_btn-span_left">
					<span id="default-form_btn-span_right">Registrar</span>
				</span>
			</button>
		</div>
   <?php echo $form->end(); ?>
         ...
         <div class="register-form-info-sub-border-top-right">
            <div class="register-form-info-sub-border-bottom-left">
               <div class="register-form-info-sub-border-bottom-right">              
                  <p>¿Eres ya miembro? <a href="#">Inicia sesión</a> | <a href="#">¿Olvidaste la contraseña?</a></p>
               </div>
            </div>
         </div>
      </div>
