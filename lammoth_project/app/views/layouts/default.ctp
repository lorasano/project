	...
	<div id="container">
		...
		<div id="index_content_top">
            ...
            <div id="index_headerbar-empty_top"><!-- --></div>
               ...
               <a href="#" id="index_header-idioms_top"><span><img src="img/index_icon-flag-spain_top.png" width="15" height="10" alt="Regístrate" />Español</span></a>
               ...
               <p class="index_header-element-special_top">|</p>
					<?php  if ($loggedIn): ?>
					<a href="/lammoth_project/users/logout" id="index_header-session_top"><span><?php e($html->image('index_icon-login_top.png',array('width'>='10', 'height'=>'10', 'alt'=>'Cerrar sesión')));?>Cerrar sesión</span></a>
               <?php  else:           ?>
               <a href="/lammoth_project/users/login" id="index_header-session_top"><span><?php e($html->image('index_icon-login_top.png', array('width'=>'10', 'height'=>'10', 'alt'=>'Regístrate')));?>Iniciar sesión</span></a>
               <?php  endif;          ?>                                         
				</div>
			</div>
			...
			<div id="index_menu-sections-and-search">
				<div id="index_sections">				   
                  ...
                  <ul>
                     <li><?php echo $html->link($html->tag('span', 'Inicio', null),array('controller'=>'users', 'action'=>'home'),array('class' => 'index_sections-elements-active'), null, false);?></li>
                     <li><!--<a href="#"><span>Buscador</span></a>--><?php echo $ajax->link($html->tag('span', 'Buscador', null), array( 'controller' => 'users', 'action' => 'prueba'), array( 'update' => 'pruebas', 'complete' => 'alert( "ya" )' ), null, false); ?></li>
